  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header Section */}
        <div className="card bg-white shadow-sm mb-6 mt-4">
          <div className="card-body">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <div className="flex-shrink-0">
                <div className="card bg-gray-100 p-4 shadow-sm">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card bg-white shadow-sm">
              <div className="card-body">
                <h3 className="card-title text-2xl text-black mb-4">
                ...
                <div className="space-y-4">
                  {experiences.map((exp, index) => (
                    <div key={index} className="flex gap-4 pb-4 border-b border-gray-200 last:border-b-0">
                      <div className="flex-shrink-0">
                        <div className={`w-3 h-3 rounded-full mt-2 ${exp.type === 'current' ? 'bg-black' :
                            exp.type === 'recent' ? 'bg-gray-500' : 'bg-gray-300'
                          }`}></div>
                      </div>
                      <div className="flex-1">
                    ...
                    <div key={index} className="p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {project.tech.split(', ').map((tech, techIndex) => (
                          <span key={techIndex} className="px-2 py-1 bg-white text-black text-xs rounded border border-gray-200">
                            {tech}
                          </span>
                        ))}
                      </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["HTML", "CSS", "JavaScript", "React.js", "Next.js"].map((skill, index) => (
                        <span key={index} className="px-2 py-1 bg-black text-white text-xs rounded">{skill}</span>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["Node.js", "PHP", "Python", "Lua"].map((skill, index) => (
                        <span key={index} className="px-2 py-1 bg-gray-700 text-white text-xs rounded">{skill}</span>
                      ))}
                    </div>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2 text-gray-700">Database</h4>
                    <div className="flex flex-wrap gap-2">
                      {["MySQL", "MariaDB", "MongoDB", "PostgreSQL"].map((skill, index) => (
                        <span key={index} className="px-2 py-1 bg-gray-500 text-white text-xs rounded">{skill}</span>
                      ))}
                    </div>
                  </div>
                </div>
              ...
              <div className="card-body">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-600">โรงเรียนสว่างแดนดิน</p>
                    <p className="text-gray-500 text-sm">สว่างแดนดิน, สกลนคร</p>
                  </div>
                </div>
              </div>
            </div>
