        ...
        <div className="mt-8 flex flex-col gap-4">
            <div className="flex flex-col gap-4 text-xl md:text-5xl font-semibold leading-normal md:leading-16">
                <div className="flex justify-center md:justify-start items-center gap-4">
                    <span>Hi, I'm</span>
                    <Image src="/my-profile-01.jpg" alt="My Avatar" width={70} height={70} className="rounded-3xl border-3 border-white shadow-lg shadow-zinc-900/50" />
                    <span>999s!</span>
            ...
            <div className="flex items-center justify-center flex-wrap md:justify-start gap-4 mt-1 md:mt-6">
                ...
                <button className="btn btn-neutral btn-lg shadow-none rounded-3xl font-medium" onClick={() => window.open('https://discord.com/users/723157846635839499', '_blank')?.focus()}>
                ...
                <button className="btn btn-lg shadow-none rounded-3xl font-medium" onClick={() => window.open('https://github.com/mysbryce', '_blank')?.focus()}>
